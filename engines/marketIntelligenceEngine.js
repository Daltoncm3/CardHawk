...
const decisionIntelligenceEngine = require('./decisionIntelligenceEngine');
...
function evaluateMarketIntelligence(input = {}) {
  ...
  const demandQuality = demandQualityEngine.evaluateDemandQuality({
    listing: input.listing,
    evidenceSummary,
  ...
  const supplyPressure = supplyPressureEngine.evaluateSupplyPressure({
    listing: input.listing,
    evidenceSummary,
    valuationRange,
    demandQuality,
  ...
  const decisionIntelligence = decisionIntelligenceEngine.evaluateDecisionIntelligence({
    evidenceSufficiency,
    listingSimilarity: input.listingSimilarity,
    comparableQuality,
    valuationRange,
    supplyPressure
  });
